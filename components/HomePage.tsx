  ...
  return (
    <div className="flex justify-center items-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-4 sm:px-8 lg:px-16 w-full min-h-screen">
      <div className="flex md:flex-row flex-col-reverse items-center gap-16 py-16 w-full max-w-7xl">
              ...
              <div className="space-y-5">
                ...
                <div className="flex gap-4">
                  {[
                    ...
                    >
                      <div
                        className={`absolute inset-0 bg-gradient-to-br ${item.gradient} rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                      />
                      <button
                        onClick={item.action}
        ...
        >
          <div className="group relative w-72 md:w-96 h-72 md:h-96 rounded-full ring-8 ring-cyan-400/10 overflow-hidden">
            {/* Gradient Background */}
            <div className="absolute inset-0 bg-linear-to-br from-cyan-400/30 to-blue-500/30 opacity-40 blur-3xl rounded-full animate-pulse-slow" />
