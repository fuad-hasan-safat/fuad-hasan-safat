...
export default function InformationCard({ title, subtitleInfo, cgpa, children }: CardProps) {
  return (
    <div
      className={`w-full max-w-[650px] bg-white hover:bg-gray-950 rounded-md z-[999] shadow-md shadow-slate-900 my-[25px] py-[30px] px-[20px] font-exo_2 relative ease-in-out duration-500`}
    >
      <h1 className={`text-3xl pr-[50px] text-slate-800`}>{title}</h1>
